...
import { canConfirmReview, cloneReviewModules, groupReviewSessions, initialExpandedModuleIds, initialExpandedSessionIds, moduleIssueCount, revealReviewIssue, reviewIssues, sessionIssueFields } from '~/utils/timetable-import/timetable-review'
...
const attentionItems = computed(() => reviewIssues(modules.value))
